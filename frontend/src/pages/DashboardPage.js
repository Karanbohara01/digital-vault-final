...
//     const navigate = useNavigate(); // 2. Initialize navigate for the Edit button
...
//     // 3. NEW: Function to handle deleting a product
...
//             // Update the UI instantly by removing the deleted product from the local state
...
//         // We can show an error if the product data is missing for some reason
//         if (!productId || !productName) {
//             alert('Error: Product information is missing for this order.');
//             return;
//         }
...
//             // Use the product name for the downloaded file
...
//                 </div>
//                 <Link to="/update-password" className="password-change-link">
...
//                     >
//                         <i className="icon-box"></i> My Products
//                     </button>
//                 )}
...
//                     >
//                         <i className="icon-shopping-bag"></i> My Orders
//                     </button>
//                 )}
...
//                             <p>Use the tabs above to manage your {user?.role === 'creator' ? 'products' : 'orders'} or account settings.</p>
//                         </div>
//                     </div>
//                 )}
...
//                             <h2>My Products</h2>
//                             <Link to="/create-product" className="primary-button">
//                                 <i className="icon-plus"></i> Create New Product
//                             </Link>
//                         </div>
...
//                                                     <div className="product-info">
//                                                         <div className="product-thumbnail">
//                                                             {/* Check for the correct property: order.product?.filePath */}
//                                                             {order.product?.filePath ? (
//                                                                 // Construct the full URL to the backend image
//                                                                 <img
//                                                                     src={
//                                                                         order.product?.filePath
//                                                                             ? `http://localhost:5001/${order.product.filePath}`
//                                                                             : 'https://www.digitalarchaeologyfoundation.com/wp-content/uploads/2015/11/One-of-the-oldest-photo-of-Kathmandu-Durbar-Square.jpg'
//                                                                     }
//                                                                     alt={order.product?.name || 'Product image'}
//                                                                     style={{ width: '50px', height: '50px', objectFit: 'cover', borderRadius: '8px' }} // optional styling
//                                                                 />

//                                                             ) : (
//                                                                 // Fallback icon if no image path exists
//                                                                 <i className="icon-image"></i>
//                                                             )}
//                                                         </div>
//                                                         <span>{order.product?.name || 'Product not found'}</span>
//                                                     </div>
//                                                 </td>
...
// import SettingsPage from './SettingsPage';
// import './DashboardPage.css'; // Your beautiful CSS file
...
//             <div className="dashboard-content">
//                 {activeTab === 'dashboard' && <div><p>Use the tabs to manage your account.</p></div>}
...
//                         <div className="section-header">
//                             <h2>My Products</h2>
//                             <Link to="/create-product" className="primary-button">Create New Product</Link>
//                         </div>
...
//                 {/* --- 2. NEW Admin's "Activity Logs" Tab Content --- */}
...
//                         {loading ? <p>Loading...</p> : data.length > 0 ? (
//                             <table className="data-table">
//                                 <thead><tr><th>Timestamp</th><th>Level</th><th>Action</th><th>User</th><th>Details</th></tr></thead>
//                                 <tbody>
//                                     {data.map(log => (
//                                         <tr key={log._id}>
//                                             <td>{new Date(log.createdAt).toLocaleString()}</td>
//                                             <td><span className="status-badge" style={log.level === 'fatal' ? { backgroundColor: '#dc3545', color: 'white' } : {}}>{log.level.toUpperCase()}</span></td>
//                                             <td>{log.action}</td>
//                                             <td>{log.user ? log.user.email : 'System/Unknown'}</td>
